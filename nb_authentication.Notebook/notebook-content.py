...
with service_principal_authentication(
    key_vault_uri="https://rs-vault-dev.vault.azure.net/",
    key_vault_tenant_id="AzureTenantId",
    key_vault_client_id="FabricSpnId",
    key_vault_client_secret="FabricSpnSecret"
):
